...
> 이 저장소에는 프로젝트가 둘 있습니다. 저장소 루트가 **하브루타 톡**이고,
> `eyefit/` 디렉터리에 별개의 프로젝트인 **렌즈값 계산기** — 도수와 테 치수로 안경 렌즈
> 두께를 계산해 더 비싼 렌즈가 값을 하는지 mm 단위로 보여주는 도구 — 가 들어 있습니다.
> 의존성과 DB, 배포가 모두 따로입니다. ([eyefit/README.md](eyefit/README.md))
